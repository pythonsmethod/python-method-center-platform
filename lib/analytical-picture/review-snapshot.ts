...
export type StoredReviewSnapshot = {
  ...
  rowIndex: number;
  row: unknown;
  provenance: { level: "DOCUMENT"; page: null; sourceFileHash: null };
};
...
export function makeReviewSnapshot(input: Omit<StoredReviewSnapshot, "version" | "provenance">): StoredReviewSnapshot | null {
  ...
  return structuredClone({ ...input, version: "stored-extraction-review-v1", provenance: { level: "DOCUMENT", page: null, sourceFileHash: null } });
}
