  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Стоимость доставки и отдельный сервисный сбор к цене личного сопровождения не добавляются. Итоговая сумма показывается до подтверждения оплаты.",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "No separate delivery charge or service fee is added to the Personal Support price. The total is shown before you confirm payment.",
