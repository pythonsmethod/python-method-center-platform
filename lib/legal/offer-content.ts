...
const RU: OfferDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Разбор анализов — 500 USD. Личный разбор ваших анализов от Professor Python без сопровождения: обратная связь по состоянию организма и рекомендации файлом в личный кабинет — до трёх рабочих дней после загрузки документов, затем три рабочих дня открытого чата с Professor Python для вопросов. Предоставляется один раз за одну оплату и ни к чему не обязывает: переходить на сопровождение или нет, вы решаете сами.",
        ...
        "Итоговая сумма к оплате. К каждому платежу добавляется сервисный сбор за обработку международного платежа — 5%. Итог по формату «5 недель»: 1 200 USD + 5% + 180 USD доставки = 1 440 USD. Итог по формату «100 дней»: 3 500 USD + 5% = 3 675 USD. Итог по формату «Разбор анализов»: 500 USD + 5% = 525 USD.",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "The final amount payable. A service fee for processing an international payment — 5% — is added to every payment. Total for the 5-week format: 1,200 USD + 5% + 180 USD delivery = 1,440 USD. Total for the 100-day format: 3,500 USD + 5% = 3,675 USD. Total for the analyses review: 500 USD + 5% = 525 USD.",
