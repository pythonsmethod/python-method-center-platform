...
const ru = {
  cabinet: {
    ...
    profileForm: {
      ...
      avatarHint: "JPEG, PNG, WebP или HEIC/HEIF, исходный файл не больше 25 МБ.",
      avatarChoose: "Выбрать из галереи",
      avatarCamera: "Сделать фото",
      avatarUploading: "Загружаю фотографию…",
      avatarTooLarge: "Фотография слишком большая. Выберите файл не больше 25 МБ.",
      avatarUnsupported: "Не удалось прочитать фотографию. Выберите JPEG, PNG, WebP или HEIC/HEIF.",
      name: "Имя и фамилия",
  ...
  onboarding: {
    ...
    formLabel: "Анкета",
    fullName: "Имя и фамилия владельца аккаунта",
    fullNameHint: "Укажите минимум два слова: имя и фамилию.",
    country: "Страна",
    countryPlaceholder: "Выберите страну",
    phone: "Телефон",
    recipient: "Кто будет пациентом в этом кейсе?",
    recipientSelf: "Я владелец аккаунта и пациент",
    recipientFamily: "Я владелец аккаунта, а пациент — другой взрослый",
    ...
    patientLabel: "Данные пациента",
    patientNote: "Аккаунт, согласия и общение остаются за вами. Анкета, анализы и выводы относятся к пациенту.",
    patientName: "Имя и фамилия пациента",
    patientBirthDate: "Дата рождения пациента",
    patientRelationship: "Кем пациент вам приходится",
    patientRelationshipPlaceholder: "Например: муж, жена, отец",
    accountOwnerRole: "Кем вы приходитесь пациенту",
    accountOwnerRolePlaceholder: "Например: жена, муж, дочь, опекун",
    representationReason: "Почему вы ведёте кейс за пациента",
    representationReasonPlaceholder: "Например: тяжёлое состояние или пациент не может общаться",
    representativeConfirm: "Подтверждаю, что имею право передавать данные и документы этого пациента.",
    patientDataConsent: "Даю согласие на обработку персональных и медицинских данных этого пациента.",
    responsibilityAcknowledged: "Понимаю, что отвечаю за достоверность данных и доступ к кейсу.",
    guardianNote:
    ...
    errorMinorFields: "Укажите данные пациента, обе роли и причину представительства.",
    errorRepresentative: "Подтвердите полномочия, согласие и ответственность за кейс.",
    ...
    errorFullName: "Укажите имя и фамилию полностью.",
    errorCountry: "Выберите страну.",
...
const en: typeof ru = {
  cabinet: {
    ...
    profileForm: {
      ...
      avatarHint: "JPEG, PNG, WebP, or HEIC/HEIF; source file up to 25 MB.",
      avatarChoose: "Choose from gallery",
      avatarCamera: "Take a photo",
      avatarUploading: "Uploading photo…",
      avatarTooLarge: "The photo is too large. Choose a file up to 25 MB.",
      avatarUnsupported: "The photo could not be read. Choose a JPEG, PNG, WebP, or HEIC/HEIF file.",
  ...
  onboarding: {
    ...
    fullName: "Account owner's first and last name",
    fullNameHint: "Enter at least two words: first and last name.",
    country: "Country",
    countryPlaceholder: "Select a country",
    phone: "Phone",
    recipient: "Who is the patient in this case?",
    recipientSelf: "I am the account owner and the patient",
    recipientFamily: "I own the account; the patient is another adult",
    ...
    patientNote: "The account, consents, and communication remain yours. The questionnaire, documents, and conclusions belong to the patient below.",
    patientName: "Patient's full name",
    patientBirthDate: "Patient's date of birth",
    patientRelationship: "How the patient is related to you",
    patientRelationshipPlaceholder: "For example: husband, wife, father",
    accountOwnerRole: "Your relationship to the patient",
    accountOwnerRolePlaceholder: "For example: wife, husband, daughter, guardian",
    representationReason: "Why you are managing the case for the patient",
    representationReasonPlaceholder: "For example: severe illness or the patient cannot communicate independently",
    representativeConfirm: "I confirm I am authorized to submit this patient's information and documents.",
    patientDataConsent: "I consent to processing this patient's personal and medical information.",
    responsibilityAcknowledged: "I understand that I am responsible for the information supplied and access to this case.",
    guardianNote:
    ...
    errorMinorFields: "Provide the patient's details, both relationships, and the reason you represent them.",
    errorRepresentative: "Confirm your authority, consent, and responsibility for this case.",
    ...
    errorFullName: "Please enter both first and last name.",
