...
const paymentProductLabels: LocalizedLabels = {
  ru: { preliminary_assessment: "Оценка состояния", personal_support: "Личное сопровождение", support_5_weeks: "Архив: сопровождение — 5 недель", support_15_weeks: "Архив: сопровождение — 100 дней", test_access: "Архивный тестовый доступ" },
  en: { preliminary_assessment: "Condition assessment", personal_support: "Personal Support", support_5_weeks: "Archive: Support — 5 weeks", support_15_weeks: "Archive: Support — 100 days", test_access: "Archived test access" }
};
