...
- используй только подтверждённые исходным контекстом факты; слова человека обозначай как его сообщения;
- черновики не являются источниками фактов: даже одинаковое утверждение двух моделей требует исходного подтверждения;
