...
export const voiceCopy = {
  ru: {
    ...
    disclosure: "Вы услышите голос ИИ. Нажимая кнопку, вы разрешаете передать речь внешнему голосовому сервису и сохранить реплики текстом. Платформа не записывает аудиофайл. Это тест клиентского помощника. По вашему вопросу передаются сведения только о вашем случае: история чата, анкеты, переписка, документы с готовой расшифровкой и другие доступные записи. Для интернет-поиска внешний сервис получает отдельный общий запрос. Ответы и ссылки сохраняются в чате. Анхам не ставит диагнозы и не назначает лечение.",
  ...
  en: {
    ...
    disclosure: "You will hear an AI voice. Starting allows speech to be sent to an external voice service and turns to be saved as text. The platform does not record an audio file. This is a client assistant preview. Your question may supply information only about your own case: chat history, questionnaires, messages, documents with existing readings and other available records. Web search sends a separate public-topic query to an external service. Answers and links are saved in chat. Anham does not diagnose or prescribe treatment.",
