...
export const voiceCopy = {
  ru: {
    ...
    continueInChat: "Завершить голос — ответ придёт в чат",
    backgroundHint: "Можно завершить голосовой разговор: поиск продолжится без оплаты голосового времени, а ответ появится в этом чате.",
  ...
  en: {
    ...
    continueInChat: "End voice — receive the answer in chat",
    backgroundHint: "You can end the voice conversation. The search will continue without voice time charges, and the answer will appear in this chat.",
    ...
    disclosure: "You will hear an AI voice. Starting allows speech to be sent to an external voice service and turns to be saved as text. The platform does not record an audio file. This is a client assistant preview. Your question may supply information only about your own case: chat history, questionnaires, messages, documents with existing readings and other available records. At your request, Anham can prepare a change to your cabinet data or a message to Professor Python; it is written only after your separate spoken confirmation. Web search sends a separate public-topic query to an external service. Answers, links and confirmed actions are saved. Anham does not diagnose or prescribe treatment.",
