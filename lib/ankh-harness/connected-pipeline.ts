...
import { buildConnectedCasePicture, type CaseEvidenceObservation } from "@/lib/ankh-harness/case-picture";
import {
...
export type ConnectedHarnessRun = {
  ...
  picture: ReturnType<typeof buildConnectedCasePicture>;
...
export function runConnectedAnkhHarness(input: ConnectedHarnessInput): ConnectedHarnessRun {
  ...
  const picture = buildConnectedCasePicture({ caseId: input.caseAlias, observations, expectedContext: input.expectedContext });
