...
2026-09-18 source-derived deskew candidate: commit dec973e adds a reversible normalized-coordinate derivative before laboratory row association, with a fail-closed semantic-header geometry fallback for providers that emit axis-aligned token boxes. The estimator uses only OCR geometry (never fixture angle or Gold), records method/slope/sample/MAD plus source and derivative geometry hashes, retains every original token polygon/span, and rejects unstable, excessive or out-of-page transforms. All candidates remain NEEDS_REVIEW; 0 VERIFIED by construction. Local tilted-table regressions pass; full suite 1855 passed, 1 skipped; TypeScript, ESLint, security 6/6/inventory, diff check and npm audit pass. Vercel Preview for dec973e is Ready; the header-fallback follow-up is not yet deployed. The new live three-raster repeat is pending one admin sign-in on the stable branch alias, so robust-layout acceptance remains NOT CLOSED. Evidence: docs/ankh/source_derived_deskew_2026_09_18.md.

2026-09-17 spatial lab bridge live: commit 6409280 connects existing token geometry reconstruction to review-only canonical facts in the isolated diagnostic. Clean and degraded fixtures each produced 6/6 exact rows; rotated 3-degree fixture produced 0/6 (NO_SUPPORTED_SPATIAL_TABLE). Total 12/18 versus previous 0/18; 0 VERIFIED. All emitted cell anchors validated. Unit whitespace normalization remains unresolved for mg / L etc.; artificial terminology remains unresolved by design. Full suite 1852 passed, 1 skipped; audit retry zero vulnerabilities. No PHI/schema/production writes. Robust layout/full-chain acceptance NOT CLOSED. Evidence and seven next gates: docs/ankh/spatial_lab_bridge_2026_09_17.md.
