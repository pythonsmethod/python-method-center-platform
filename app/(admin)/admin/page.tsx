          ...
          <div className="panel">
            ...
            {assistantConfigured ? (
              <AssistantChat
                ...
                intro="Здравствуйте, Professor Python! Вставьте вопрос клиента, текст анкеты или задачу — помогу с черновиком ответа, выжимкой или планом. Можно прикрепить фото или PDF (скрепка внизу): я прочитаю анализ, снимок документа или таблицу. Файлы нигде не сохраняются — я смотрю их только для этого ответа."
