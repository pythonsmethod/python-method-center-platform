      ...
      <section className="intake-section" aria-label="ИИ-Ассистент по кейсу">
        <div className="panel">
          ...
          <p>
            ...
            но его можно приложить прямо в чат скрепкой: фото анализа, PDF
            или текст. Приложенное нигде не сохраняется.
          </p>
          <AssistantChat
            attachments
            caseId={clientCase.id}
            endpoint="/api/assistant/staff"
            intro="Я вижу данные этого кейса: анкету, статусы, список документов, оплаты и историю. Спросите — сделаю выжимку, черновик ответа клиенту или предложу следующие шаги. Фото и PDF можно приложить скрепкой — прочитаю. Решения — за Professor Python."
