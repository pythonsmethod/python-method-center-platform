...
export default async function ClientAssistantPage() {
  ...
  return <section className="panel">
    ...
    <AssistantChat endpoint="/api/assistant/client" historyEndpoint="/api/assistant/history" voiceScope="client" locale={locale} intro={locale === "ru" ? "Здравствуйте! Чем помочь с вашим случаем или личным кабинетом?" : "Hello! How can I help with your case or account?"} />
  </section>;
}
