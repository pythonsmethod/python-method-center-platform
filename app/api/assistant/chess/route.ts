...
export async function POST(request: Request) {
  ...
  const levels = ["beginner", "casual", "intermediate", "advanced", "expert", "master", "grandmaster"];
