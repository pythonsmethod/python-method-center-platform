...
2026-09-18 deskew implementation is locally complete and Preview Ready at dec973e. Next gate is the authenticated live repeat of clean/rotated/degraded fixed rasters; accept only if the rotated table reconstructs 6/6 source-exact rows, clean/degraded do not regress, every original anchor remains valid and effective VERIFIED stays 0. After that: conservative unit-whitespace normalization, two unfamiliar laboratory layouts, and region-level native/fallback coverage reconciliation. Persistence, whole-Case, blind Gold, Karen and PHI/production gates remain open. Details: docs/ankh/source_derived_deskew_2026_09_18.md.
