...
Дата проверки: 2026-09-10. Ветка `codex/gpt-live-pilot`, база `425c1a4`.
...
Сервер проверяет origin, размер запроса, Supabase-пользователя, active status,
...
- Полная регрессия: **1662 passed**, 174 файла; один opt-in provider test skipped
